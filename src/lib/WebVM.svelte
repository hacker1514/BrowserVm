<script>
	...
	async function initCheerpX()
	{
		...
		try
		{
			...
			await cx.run("/bin/sh", ["-c", "mkdir -p /home/user/examples /home/user/documents 2>/dev/null || true; cp -rf /web/examples/* /home/user/examples/ 2>/dev/null || true; cp -rf /web/documents/* /home/user/documents/ 2>/dev/null || true; sed -i 's/^user:/Hacker:/g; s/^1000:1000:user/1000:1000:Hacker/g' /etc/passwd 2>/dev/null || true; grep -q '^Hacker:' /etc/passwd || echo 'Hacker:x:1000:1000:Hacker:/home/user:/bin/bash' >> /etc/passwd; grep -q '^Hacker:' /etc/group || echo 'Hacker:x:1000:' >> /etc/group; (echo 'Hacker:1234' | chpasswd || true); (echo 'root:1234' | chpasswd || true); chown -R Hacker:Hacker /home/user 2>/dev/null || true; chmod -R 755 /home/user 2>/dev/null || true; sed -i '/PROMPT_COMMAND/d; /DEBUG/d; /set_my_prompt/d' /etc/bash.bashrc /etc/profile /home/user/.bashrc 2>/dev/null || true; echo \"export LS_COLORS='ow=01;34:tw=01;34:st=01;34:di=01;34'\" >> /etc/bash.bashrc; echo \"export LS_COLORS='ow=01;34:tw=01;34:st=01;34:di=01;34'\" >> /home/user/.bashrc; echo \"alias ls='ls --color=auto -I index.list'\" >> /etc/bash.bashrc; echo \"alias ls='ls --color=auto -I index.list'\" >> /home/user/.bashrc; echo 'set_my_prompt() { export PS1=\"\\[\\033[1;34m\\][[ \\[\\033[1;33m\\]K \\[\\033[1;37m\\]: \\[\\033[1;32m\\]\\w \\[\\033[1;34m\\]]] \\[\\033[1;37m\\]: \\[\\033[1;35m\\]\\$ \\[\\033[1;36m\\]\"; trap \"printf \\\"\\\\033[1;37m\\\"\" DEBUG; }' >> /etc/bash.bashrc; echo 'PROMPT_COMMAND=set_my_prompt' >> /etc/bash.bashrc; echo 'set_my_prompt() { export PS1=\"\\[\\033[1;34m\\][[ \\[\\033[1;33m\\]K \\[\\033[1;37m\\]: \\[\\033[1;32m\\]\\w \\[\\033[1;34m\\]]] \\[\\033[1;37m\\]: \\[\\033[1;35m\\]\\$ \\[\\033[1;36m\\]\"; trap \"printf \\\"\\\\033[1;37m\\\"\" DEBUG; }' >> /home/user/.bashrc; echo 'PROMPT_COMMAND=set_my_prompt' >> /home/user/.bashrc"], { uid: 0, gid: 0 });
		}
		catch(e)
		{
